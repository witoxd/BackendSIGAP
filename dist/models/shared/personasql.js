...
exports.buildUpsertQuery = exports.buildUpdateQuery = exports.personaJoin = exports.PERSONA_FIELDS_JSON = exports.PERSONA_FIELDS_SQL = void 0;
// ----------------------------------------------------------
...
`.trim();
exports.personaJoin = personaJoin;
// ----------------------------------------------------------
...
// ----------------------------------------------------------
const buildUpdateQuery = (tableName, primaryKey, id, data, excludeKeys = []) => {
...
//   await query(sql, values, client)
// ----------------------------------------------------------
const buildUpsertQuery = (tableName, conflictKey, conflictValue, data) => {
    const fields = Object.keys(data).filter((k) => k !== conflictKey && data[k] !== undefined);
    if (fields.length === 0)
        return null;
...
//# sourceMappingURL=personasql.js.map