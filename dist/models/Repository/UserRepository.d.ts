...
export declare class UserRepository {
    ...
    static create(data: Omit<UsuarioCreationAttributes, "usuario_id" | "fecha_creacion" | "activo">): Promise<any>;
    ...
    static assignRole(userId: number, roleId: number): Promise<any>;
