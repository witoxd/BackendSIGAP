...
class EstudianteController {
    ...
    create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { newPersona, newEstudiante } = yield (0, database_1.transaction)((client) => __awaiter(this, void 0, void 0, function* () {
                ...
                const existingEstudiante = yield EstudianteRepository_1.EstudianteRepository.findByPersonaId(newPersona.persona_id);
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const updatedEstudiante = yield (0, database_1.transaction)((client) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (persona) {
                    ...
                    if (persona.numero_documento) {
                        const personaConflicto = yield PersonaRepository_1.PersonaRepository.findByDocumento(persona.numero_documento);
                    ...
                    yield PersonaRepository_1.PersonaRepository.update(existing.persona_id, persona, client);
                }
            ...
            const updatedPersona = yield PersonaRepository_1.PersonaRepository.findById(existing.persona_id);
