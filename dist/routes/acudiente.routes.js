...
router.get("/searchIndex/:index", (0, express_validator_1.param)("index").isString().withMessage("Index de busqueda invalido"), validate_1.validate, (0, acl_1.checkPermission)(types_1.Recurso.ACUDIENTES, types_1.Accion.READ), acudienteController.SearchIndex.bind(acudienteController));
router.get("/:id/estudiantes", (0, express_validator_1.param)("id").isInt({ min: 1 }).withMessage("ID de estudiante invalido"), validate_1.validate, (0, acl_1.checkPermission)(types_1.Recurso.ESTUDIANTES, types_1.Accion.READ), acudienteController.getAcudientesByEstudiante.bind(acudienteController));
