...
router.patch("/:id/status/:activo", auth_1.isAdmin, validators_1.idValidator, (0, express_validator_1.param)("activo").isBoolean().withMessage("activo debe ser booleano"), validate_1.validate, userController.toggleStatus.bind(userController));
