...
router.get("/searchIndex/:index", (0, express_validator_1.param)("index").isString().withMessage("Index de busqueda invalido"), validate_1.validate, (0, acl_1.checkPermission)(types_1.Recurso.PROFESORES, types_1.Accion.READ), profesorController.SearchIndex.bind(profesorController));
